...
Insert Livro (LIVNOME, LIVAUTOR) values ('Vidas Secas', 'Gliciliano Ramos')
--select * from Livro
go
...
Insert CAPITULO (CAPDESCRICAO, LIVID) values ('Soldado amarelo', 2)
Insert CAPITULO (CAPDESCRICAO, LIVID) values ('Mundo coberto de penas', 2)
