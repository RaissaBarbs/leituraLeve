...
E a viagem prosseguiu, mais lenta, mais arrastada, num silêncio grande',1)
go
insert CARDTEXTO (CARTEXTO, CAPID) values (
...
cabeça, os ossos do amigo, e não guardava lembrança disto. Agora, enquanto parava, dirigia as pupilas brilhantes aos objetos
familiares, estranhava não ver sobre o baú de folha a gaiola pequena onde a ave se equilibrava mal.',1)

go
insert CARDTEXTO (CARTEXTO, CAPID) values (
'Fabiano também às vezes
sentia falta dela, mas logo a recordação chegava. Tinha andado a procurar raízes, à toa: o resto de farinha acabara, não se
ouvia um berro de rês perdida na catinga. Sinha Vitória, queimando o assento no chão, as mãos cruzadas segurando os joelhos
ossudos, pensava em acontecimentos antigos que não se relacionavam: festas de casamento, vaquejadas, novenas, tudo numa
confusão. Despertara-a um grito áspero, vira de perto a realidade e o papagaio, que andava furioso, com os pés apalhetados,
numa atitude ridícula. Resolvera de supetão aproveitá-lo como alimento e justificara-se declarando a si mesma que ele era
mudo e inútil. Não podia deixar de ser mudo. Ordinariamente a família falava pouco. E depois daquele desastre viviam todos
...
Num cotovelo do caminho avistou um canto de cerca, encheu-o a esperança de achar comida, sentiu desejo de cantar. A voz
saiu-lhe rouca, medonha. Calou-se para não estragar força.
Deixaram a margem do rio, acompanharam a cerca, subiram uma ladeira, chegaram aos juazeiros. Fazia tempo que não viamsombra.
Sinha Vitória acomodou os filhos, que arriaram como trouxas, cobriu-os com molambos. O menino mais velho, passada a
vertigem que o derrubara, encolhido sobre folhas secas, a cabeça encostada a uma raiz, adormecia, acordava. E quando abria
os olhos, distinguia vagamente um monte próximo, algumas pedras, um carro de bois. A cachorra Baleia foi enroscar-se junto
dele',1)

go
insert CARDTEXTO (CARTEXTO, CAPID) values (
'Estavam no pátio de uma fazenda sem vida. O curral deserto, o chiqueiro das cabras arruinado e também deserto, a casa do
...
resistência, penetrou num cercadinho cheio de plantas mortas, rodeou a tapera, alcançou o terreiro do fundo, viu um barreiro
vazio, um bosque de catingueiras murchas, um pé de turco e o prolongamento da cerca do curral. Trepou-se no mourão do
canto, examinou a catinga, onde avultavam as ossadas e o negrume dos urubus. Desceu, empurrou a porta da cozinha. Voltou
desanimado, ficou um instante no copiar, fazendo tenção de hospedar ali a família. Mas chegando aos juazeiros, encontrou os
meninos adormecidos e não quis acordá-los. Foi apanhar gravetos, trouxe do chiqueiro das cabras uma braçada de madeira
meio roída pelo cupim, arrancou touceiras de macambira, arrumou tudo para a fogueira.
Nesse ponto Baleia arrebitou as orelhas, arregaçou as ventas, sentiu cheiro de preás, farejou um minuto, localizou-os no
morro próximo e saiu correndo',1)

go
insert CARDTEXTO (CARTEXTO, CAPID) values (
'Fabiano seguiu-a com a vista e espantou-se: uma sombra passava por cima do monte. Tocou o braço da mulher, apontou o
céu, ficaram os dois algum tempo aguentando a claridade do sol. Enxugaram as lágrimas, foram agachar-se perto dos filhos,
suspirando, conservaram-se encolhidos, temendo que a nuvem se tivesse desfeito, vencida pelo azul terrível, aquele azul que
deslumbrava e endoidecia a gente.
Entrava dia e saía dia. As noites cobriam a terra de chofre. A tampa anilada baixava, escurecia, quebrada apenas pelas
vermelhidões do poente.
Miudinhos, perdidos no deserto queimado, os fugitivos agarraram-se, somaram as suas desgraças e os seus pavores. Ocoração de Fabiano bateu junto do coração de sinha Vitória, um abraço cansado aproximou os farrapos que os cobriam.
Resistiram à fraqueza, afastaram-se envergonhados, sem ânimo de afrontar de novo a luz dura, receosos de perder a esperança
que os alentava.',1)
go
insert CARDTEXTO (CARTEXTO, CAPID) values (
'Iam-se amodorrando e foram despertados por Baleia, que trazia nos dentes um preá. Levantaram-se todos gritando. Omenino mais velho esfregou as pálpebras, afastando pedaços de sonho. Sinha Vitória beijava o focinho de Baleia, e como o
focinho estava ensanguentado, lambia o sangue e tirava proveito do beijo.
Aquilo era caça bem mesquinha, mas adiaria a morte do grupo. E Fabiano queria viver. Olhou o céu com resolução. Anuvem tinha crescido, agora cobria o morro inteiro. Fabiano pisou com segurança, esquecendo as rachaduras que lhe
estragavam os dedos e os calcanhares.
Sinha Vitória remexeu no baú, os meninos foram quebrar uma haste de alecrim para fazer um espeto. Baleia, o ouvido
...
Cavou a areia com as unhas, esperou que a água marejasse e, debruçando-se no chão, bebeu muito. Saciado, caiu de papo para
cima, olhando as estrelas, que vinham nascendo. Uma, duas, três, quatro, havia muitas estrelas, havia mais de cinco estrelas no
céu. O poente cobria-se de cirros — e uma alegria doida enchia o coração de Fabiano.',1)
go
insert CARDTEXTO (CARTEXTO, CAPID) values (
'Pensou na família, sentiu fome. Caminhando, movia-se como uma coisa, para bem dizer não se diferençava muito da
bolandeira de seu Tomás. Agora, deitado, apertava a barriga e batia os dentes. Que fim teria levado a bolandeira de seu
Tomás?
Olhou o céu de novo. Os cirros acumulavam-se, a lua surgiu, grande e branca. Certamente ia chover.
Seu Tomás fugira também, com a seca, a bolandeira estava parada. E ele, Fabiano, era como a bolandeira. Não sabia por
que, mas era. Uma, duas, três, havia mais de cinco estrelas no céu. A lua estava cercada de um halo cor de leite. Ia chover.
...
Lembrou-se dos filhos, da mulher e da cachorra, que estavam lá em cima, debaixo de um juazeiro, com sede. Lembrou-se do
preá morto. Encheu a cuia, ergueu-se, afastou-se, lento, para não derramar a água salobra. Subiu a ladeira. A aragem morna
sacudia os xiquexiques e os mandacarus. Uma palpitação nova. Sentiu um arrepio na catinga, uma ressurreição de garranchos e
folhas secas.',1)
go
insert CARDTEXTO (CARTEXTO, CAPID) values (
'Chegou. Pôs a cuia no chão, escorou-a com pedras, matou a sede da família. Em seguida acocorou-se, remexeu o aió, tirou o
...
Eram todos felizes. Sinha Vitória vestiria uma saia larga de ramagens. A cara murcha de sinha Vitória remoçaria, as
nádegas bambas de sinha Vitória engrossariam, a roupa encarnada de sinha Vitória provocaria a inveja das outras caboclas.
A lua crescia, a sombra leitosa crescia, as estrelas foram esmorecendo naquela brancura que enchia a noite. Uma, duas, três,
agora havia poucas estrelas no céu. Ali perto a nuvem escurecia o morro.
A fazenda renasceria — e ele, Fabiano, seria o vaqueiro, para bem dizer seria dono daquele mundo.
Os troços minguados ajuntavam-se no chão: a espingarda de pederneira, o aió, a cuia de água e o baú de folha pintada. Afogueira estalava. O preá chiava em cima das brasas.
Uma ressurreição. As cores da saúde voltariam à cara triste de sinha Vitória. Os meninos se espojariam na terra fofa do
chiqueiro das cabras. Chocalhos tilintariam pelos arredores. A catinga ficaria verde.
Baleia agitava o rabo, olhando as brasas. E como não podia ocupar-se daquelas coisas, esperava com paciência a hora de
